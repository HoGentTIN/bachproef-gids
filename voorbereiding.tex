...
\begin{framed}
	Het is niet verplicht {\LaTeX} te gebruiken. Je mag Word gebruiken, op voorwaarde dat je de opmaak van de voorgestelde template (zoals hierboven gerefereerd) volledig overneemt. Er is geen Word template beschikbaar.
\end{framed}
