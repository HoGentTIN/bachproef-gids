...
\begin{remark}[!!]
  Het gebruik van de APA-stijl is verplicht over heel HOGENT. Dat geldt zowel voor de opmaak van de literatuurlijst als verwijzingen naar bronnen in de tekst.
\end{remark}
